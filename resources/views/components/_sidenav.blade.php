...
>
  ...
  <div class="d-flex px-2">
    <div class="sidebar-brand-icon mx-1">
      <img
        src="assets/img/akses-logo-white.png"
        alt=""
    ...
    <div class="sidebar-brand-text my-auto">
      <img
        src="assets/img/akses-text-logo-white.png"
...
<li class="nav-item">
  <a class="nav-link collapsed" href="/formularium">
...
<li class="nav-item">
  ...
  >
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="/persediaan-rutin">Rutin</a>
      <a class="collapse-item" href="/persediaan-program">Program</a>
    </div>
  </div>
</li>
