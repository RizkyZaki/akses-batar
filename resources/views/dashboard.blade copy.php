...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="d-flex px-2">
                    <div class="sidebar-brand-icon mx-1">
                        <img src="/img/akses-logo-white.png" alt="" style="max-width: 35px" />
                    </div>
                    <div class="sidebar-brand-text my-auto">
                        <img src="/img/akses-text-logo-white.png" style="max-width: 100px" alt="" />
                    </div>
                </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="formularium.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="stock-rutin.html">Rutin</a>
                        <a class="collapse-item" href="stock-program.html">Program</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="farmasi-klinis.html">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Program (Data)</a>
                        <a class="collapse-item" href="reports-rutin.html">Rutin</a>
                        <a class="collapse-item" href="reports-program.html">Program</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="https://drive.google.com/file/d/1ZHCF-k_LRai8McHZsMGp8Pg0GFaX4S4X/view?usp=sharing"
                            class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-file-alt fa-sm text-white-50"></i> Petunjuk
                            Penggunaan</a>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2024 YLA, Fakultas Rekayasa Industri, Telkom
                            University</span>
                    </div>
                </div>
            </footer>
