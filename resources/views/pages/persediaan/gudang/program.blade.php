<x-_layout>
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered" id="data-persediaan-gudang-program" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>No</th>
              <th>Program</th>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="add-moda-Title">Tambah Persediaan Program</h5>
          <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3"><label for="name">Program</label><input class="form-control" name="name"
                  type="text" placeholder="Program"></div>
            </div>
            <div class="col-md-6">
  ...
  <div class="modal fade" id="change-modal" tabindex="-1" role="dialog" aria-labelledby="change-moda-Title"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="change-moda-Title">Ubah Persediaan Program</h5>
          <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="row">
  ...
  @push('customJs')
    ...
    <script src="{{ asset('custom/js/persediaan/gudang/program.js') }}"></script>
